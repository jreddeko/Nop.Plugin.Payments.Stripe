...
namespace Nop.Plugin.Payments.Stripe.Data
{
    ...
    /// Object context
    /// </summary>
    public class PaymentStripeObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public PaymentStripeObjectContext(string nameOrConnectionString)
        ...
        {
            modelBuilder.Configurations.Add(new PaymentStripeEventMap());
        ...
        {
            //drop the table
            var tableName = this.GetTableName<PaymentStripeEvent>();
